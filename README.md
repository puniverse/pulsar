...
```clojure
[co.paralleluniverse/pulsar "0.7.1"]
```

Then, the following must be added to the project.clj file:

~~~ clojure
:java-agents [[co.paralleluniverse/quasar-core "0.7.1"]]
~~~
